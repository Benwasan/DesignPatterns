...
class LanComponentTest {
    public static void main(String[] args) {
        ...
        workstation1.setNextComponent(node1);
        node1.setNextComponent(workstation2);
        workstation2.setNextComponent(printServer1);
        printServer1.setNextComponent(node2);
        node2.setNextComponent(workstation3);
        workstation3.setNextComponent(printServer2);
